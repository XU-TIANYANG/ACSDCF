function results = run_ACSDCF_HC(seq,res_path, bSaveImage, parameters)

% Feature specific parameters
hog_params.cell_size = 6;
hog_params.nDim = 31;
hog_params.learning_rate = 0.6;
hog_params.channel_selection_rate = 0.8;
...
cn_params.channel_selection_rate = 0.8;
...
grayscale_params.channel_selection_rate = 0.8;
...
ic_params.channel_selection_rate = 0.8;
...
cnn_params.learning_rate = 1;
cnn_params.channel_selection_rate = 1;
...
params.temporal_consistency_factor = [36 6];
